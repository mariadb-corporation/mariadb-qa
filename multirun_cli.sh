...
REPORT_END_THREAD=1      # If set to 1, report the outcome of ended threads (slows things down considerably)
REPORT_THREADS=1         # If set to 1, report the outcome of ongoing threads (slows things down considerably)
