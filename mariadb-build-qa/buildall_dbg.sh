...
cd ${DIR}/12.3 && ~/mariadb-qa/build_mdpsms_dbg.sh &
cd ${DIR}/13.0 && ~/mariadb-qa/build_mdpsms_dbg.sh &
cd ${DIR}/13.1 && ~/mariadb-qa/build_mdpsms_dbg.sh &
...
if [ -d ${DIR}/12.3-es ]; then cd ${DIR}/12.3-es && ~/mariadb-qa/build_mdpsms_dbg.sh & fi
