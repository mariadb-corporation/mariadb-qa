...
SET sql_mode='';
CREATE TABLE t (c NUMERIC(1,1) UNSIGNED,c2 CHAR(1) BINARY CHARACTER SET 'utf8' COLLATE 'utf8_bin',c3 BIT AS (c) VIRTUAL,KEY(c)) ENGINE=MyISAM;
INSERT INTO t VALUES (FROM_UNIXTIME(1),'a','a');
CREATE INDEX idx1 ON t (c2,c3);
ANALYZE TABLE t;
