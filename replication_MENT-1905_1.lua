...
function event(thread_id)
  ...
  then
    xa_mix(thread_id, 50, dml_mix, 80, 10, 10, b_sessionmgmt_update, b_sessionmgmt_insert, b_sessionmgmt_delete)
  else
    xa_mix(thread_id, 50, dml_mix, 10, 45, 45, b_dbs_random_number_mgr_update, b_dbs_random_number_mgr_insert, b_dbs_random_number_mgr_delete)
  end
end
