...
#15 */1 * * * roel ${HOME}/mariadb-qa/pquery-auto-clean.sh 235746 >> /sda/235746_pquery-auto-clean.out 2>&1
#30 */1 * * * roel ${HOME}/mariadb-qa/pquery-auto-clean.sh 629181 >> /sda/629181_pquery-auto-clean.out 2>&1
#45 */1 * * * roel ${HOME}/mariadb-qa/pquery-auto-clean.sh 663235 >> /sda/663235_pquery-auto-clean.out 2>&1
