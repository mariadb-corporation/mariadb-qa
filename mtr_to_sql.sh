...
cat ${TESTS_PATH}/*/*.test ${TESTS_PATH}/*/*/*.test ${TESTS_PATH}/*/*/*/*.test ${TESTS_PATH}/*/*/*/*/*.test ${DIRECTORY}/*/*/*.inc ${DIRECTORY}/*/*/*/*.inc ${DIRECTORY}*/*/*/*/*.inc ${DIRECTORY}/*/*/*/*/*/*.inc ${DIRECTORY}/plugin/*/*/*/*.test 2>/dev/null | \
